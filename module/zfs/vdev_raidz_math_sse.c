...
{	\
	switch (REG_CNT(r)) {	\
	case 4:	\
		__asm("movntdq %%" VR3(r)", %0" : "=m" (((elem_t *)dst)[3]));\
		__asm("movntdq %%" VR2(r)", %0" : "=m" (((elem_t *)dst)[2]));\
	case 2:	\
		__asm("movntdq %%" VR1(r)", %0" : "=m" (((elem_t *)dst)[1]));\
	case 1:	\
		__asm("movntdq %%" VR0(r)", %0" : "=m" (((elem_t *)dst)[0]));\
	}\
}
...
RAIDZ_x86SIMD_GEN_WRAP(p, sse);
RAIDZ_x86SIMD_GEN_WRAP(pq, sse);
RAIDZ_x86SIMD_GEN_WRAP(pqr, sse);

RAIDZ_x86SIMD_REC_WRAP(p, sse);
RAIDZ_x86SIMD_REC_WRAP(q, sse);
RAIDZ_x86SIMD_REC_WRAP(r, sse);
RAIDZ_x86SIMD_REC_WRAP(pq, sse);
RAIDZ_x86SIMD_REC_WRAP(pr, sse);
RAIDZ_x86SIMD_REC_WRAP(qr, sse);
RAIDZ_x86SIMD_REC_WRAP(pqr, sse);
